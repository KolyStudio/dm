...
<div class="flex space-x-1 justify-center pt-4">
	...
	>
            ...
            <img id="dec" src="/icons/18.webp" alt={prenom} class="w-12 -mt-1"/>
            <div id="dec" class="">INSCRIS-TOI ET BAISE-MOI</div>
	</div>
	...
	<div class="py-3">
		...
		<div class="text-center m-auto w-[85%] font-medium text-white">
			Si tu es sceptique, testez au moins avec l'offre d'essai, tu verras  que ça
			fonctionne vraiment ! 💯🔥
		</div>
	</div>
