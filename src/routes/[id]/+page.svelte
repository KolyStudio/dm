<script>
	...
	function close() {
	  ...
	  let link = `https://rencontres-proximite.com/?abc=2ab0b5837e6c2796&xa=n&acme=wid.90880&media=social&tpls=9&v=sexy&userPhotos=45&userDistance=8&userName=MissCandy&userPicture=https://i.ibb.co/SJrcGQ5/final.jpg&s1=DIRECT&s2=` + date
